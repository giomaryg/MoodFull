  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h3 className="text-xl sm:text-2xl font-bold text-[#c17a7a]">Similar Recipes You Might Like</h3>
      </div>
            ...
            >
              <CardContent className="p-4 sm:p-5 md:p-6 space-y-3 sm:space-y-4">
                <div className="space-y-2">
                  <h4 className="font-bold text-base sm:text-lg text-gray-900 group-hover:text-[#c17a7a] transition-colors line-clamp-1">
                    {recipe.name}
                  </h4>

        ...
        <div className="w-full flex flex-col items-center sm:items-start p-4 sm:p-8 shrink-0 z-20">
          ...
          <div className="flex gap-2 sm:gap-3">
            <Button 
              ...
              variant="outline"
              type="button"
              className="border-gray-700 text-gray-800 bg-gray-100 hover:bg-gray-300 h-11 sm:h-12 px-3 sm:px-5 text-xs sm:text-sm rounded-xl disabled:opacity-30 transition-all"
            >
            ...
            {currentStep === instructions.length - 1 ? (
              <Button 
                onClick={onClose}
                type="button"
                className="bg-[#6b9b76] hover:bg-[#5a8a65] text-white h-11 sm:h-12 px-3 sm:px-5 text-xs sm:text-sm rounded-xl shadow-[0_0_20px_rgba(107,155,118,0.4)] transition-all"
              >
              ...
              <Button 
                ...
                type="button"
                className="bg-white hover:bg-gray-200 text-black h-11 sm:h-12 px-3 sm:px-5 text-xs sm:text-sm rounded-xl transition-all"
              >
